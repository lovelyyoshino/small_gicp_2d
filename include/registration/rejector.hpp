...
struct NullRejector {
  ...
  bool operator()(const TargetPointCloud& target, const SourcePointCloud& source, const Eigen::Isometry2d& T, size_t target_index, size_t source_index, double sq_dist) const {
    return false;
  }
};
