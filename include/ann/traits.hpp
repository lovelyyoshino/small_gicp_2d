...
template <typename T>
size_t knn_search(const T& tree, const Eigen::Vector3d& point, size_t k, size_t* k_indices, double* k_sq_dists) {
...
size_t nearest_neighbor_search(const T& tree, const Eigen::Vector3d& point, size_t* k_index, double* k_sq_dist) {
